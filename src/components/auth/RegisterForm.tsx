        ...
        <div className="space-y-4 animate-reveal">
          ...
          <div className="relative my-2">
            ...
            <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-bold">
              <span className="bg-card px-3 text-slate-400">Or sign up with</span>
            </div>
          </div>
          ...
          <button
            ...
            className="flex h-10 w-full items-center justify-center gap-2 rounded-lg border border-slate-200 bg-white text-sm font-semibold text-slate-700 hover:bg-slate-50 transition-colors disabled:opacity-60"
          >
            {isGoogleLoading ? (
